                                        ...
                                        <Card className='m-5 p-3'>
                                            <Card.Body>
                                                ...
                                                <Card.Text>
                                                    ...
                                                    <Link to={`/vehicleupdate/${item.vehicleId}`} onClick={Cookies.set('vehicleId', item.vehicleId)} className="btn btn-primary m-1">Edit</Link>
                                                    <Link to={`/vehicledelete/${item.vehicleId}`} onClick={Cookies.set('vehicleId', item.vehicleId)} className="btn btn-danger m-1">Delete</Link>
