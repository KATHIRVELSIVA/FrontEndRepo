            ...
            <div className="container-fluid" onLoadStart={cookieCheck}>
                <div className="row">
                    ...
                    <main className="container"><div className="chartjs-size-monitor"><div className="chartjs-size-monitor-expand"><div className=""></div></div><div className="chartjs-size-monitor-shrink"><div className=""></div></div></div>
                        ...
                        <h2>List of Policy List</h2>
                        <div>
                            <div className="d-flex justify-content-end ">
                                <Link to="/addpolicy" className="btn btn-sm btn-success">Add Policy+</Link>
                            </div>
                        ...
                        <div>
                            <div className="d-flex justify-content-end ">
                                <Link to="/addVehicle" className="btn btn-sm btn-success">Add Vehicle+</Link>
                            </div>
                            <table className="table table-striped">
                                <thead>
                                ...
                                <tbody>
                                    {
                                        data
                                            .filter((item) => item.userID == Cookies.get("UserID") && item.status === true)
                                            .map((d, i) => (
